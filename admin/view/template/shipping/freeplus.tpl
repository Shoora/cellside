					...
					<td class="center">
						...
						<?php foreach ($languages as $language) { ?>
							...
							<div style="white-space: nowrap">
								<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
								<input type="text" name="<?php echo $name; ?>_data[<?php echo $row; ?>][title][<?php echo $lcode; ?>]" value="<?php echo (!empty($rate['title'][$lcode])) ? $rate['title'][$lcode] : ''; ?>" />
							</div>
						<?php } ?>
						<br />
						<div><strong><?php echo $text_text; ?></strong></div>
						<?php foreach ($languages as $language) { ?>
							<?php $lcode = $language['code']; ?>
							<div style="white-space: nowrap">
								<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
								<input type="text" name="<?php echo $name; ?>_data[<?php echo $row; ?>][text][<?php echo $lcode; ?>]" value="<?php echo (!empty($rate['text'][$lcode])) ? $rate['text'][$lcode] : ''; ?>" />
							</div>
						<?php } ?>
						<br />
						...
						<br />
						<div><strong><?php echo $text_postcode_format; ?></strong></div>
						<div><select name="<?php echo $name; ?>_data[<?php echo $row; ?>][postcode_format]">

...
$this->data['button_vinvoice'] = $this->language->get('button_vinvoice');
			              $this->data['vinvoice'] = $this->url->link('sale/order/vinvoice', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['button_vinvoice2'] = $this->language->get('button_vinvoice2');
			              $this->data['vinvoice2'] = $this->url->link('sale/order/vinvoice', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');

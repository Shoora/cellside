  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <div id="tab-history" class="vtabs-content">
        ...
        <table class="form">
          <tr>
<td><?php echo $entry_send_invoice; ?></td>
...
$('#button-history').live('click', function() {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'html',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + encodeURIComponent($('input[name=\'notify\']').attr('checked') ? 1 : 0) + '&send_invoice=' + encodeURIComponent($('input[name=\'send_invoice\']').attr('checked') ? 1 : 0) + '&append=' + encodeURIComponent($('input[name=\'append\']').attr('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
			$('.success, .warning').remove();

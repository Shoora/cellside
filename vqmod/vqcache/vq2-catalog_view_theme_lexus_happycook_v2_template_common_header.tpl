...
<section id="page" class="offcanvas-pusher" role="main">
	...
	<div class="col-xs-12 visible-xs no-padding">
		<?php if ($logo) { ?>
			<div id="logo" style="background: #ededed; padding: 10px;"><a href="<?php echo $home; ?>"><img <?php echo ($this->config->get('config_logo_width') && $this->config->get('config_logo_height')) ? 'width="'.$this->config->get('config_logo_width').'" height="'.$this->config->get('config_logo_height').'" ' : ''; ?>src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a></div>
		<?php } ?>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-sm-6 col-xs-8 no-padding">
					<?php if ($logo) { ?>
						<div id="logo" class="hidden-xs"><a href="<?php echo $home; ?>"><img <?php echo ($this->config->get('config_logo_width') && $this->config->get('config_logo_height')) ? 'width="'.$this->config->get('config_logo_width').'" height="'.$this->config->get('config_logo_height').'" ' : ''; ?>src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a></div>
					<?php } ?>
				</div>

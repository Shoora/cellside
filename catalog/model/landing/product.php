<?php
class ModelLandingProduct extends Model {
    ...
    public function getProducts($data = array()) {
        ...
        if(!empty($data['filter_custom'])){
            ...
            if(gettype($data['filter_custom'])=="array"){
                foreach($data['filter_custom'] as $filter){
                    $sql .= $filter['concat']." ".$filter['query'];
                }
    ...
    public function getTotalProducts($data = array()) {
        ...
        $query = $this->db->query($sql);
        //echo "<pre>";print_r($query->row['total']);

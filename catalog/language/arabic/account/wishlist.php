...
$_['text_success']  = 'نجاح: قمت بإضافتها <a href="%s">%s</a> لديك <a href="%s">قائمة امنيات</a>!';
$_['text_remove']   = 'نجاح: لقد قمت بتعديل سلة المفضلة!';
$_['text_empty']    = 'قائمة رغبتكم فارغة.';

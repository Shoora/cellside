	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="qap-question-modal-title"><?php echo $heading_title_module_general; ?></h4>
			</div>
...
<div class="modal fade qap-modal" id="qap-answer-modal" role="dialog" tabindex="-1" aria-hidden="true" aria-labelledby="qap-answer-modal-title" data-keyboad="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $button_cancel; ?></button>
				<button type="button" class="btn btn-primary qap-submit"><?php echo $button_submit; ?></button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<?php } ?>
	<div class="qap-content qap-btm-margin">
		<?php if (!empty($questions) || $search) { ?>
		<div id="qap">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-4 text-right">
							...
							<input type="button" class="button qap-ask-general" value="<?php echo addslashes($button_ask); ?>" />
							<?php } else { ?>

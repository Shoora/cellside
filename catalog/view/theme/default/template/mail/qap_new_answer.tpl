														...
														<tr>
															...
															<td style="padding:0px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#333333">
																<p style="margin:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#555555;font-size:14px;padding-top:10px;">
																	<?php if ($product) { ?>
																	<?php echo sprintf($text_product_question_answer, $author, '<a href="' . $product_url . '" style="text-decoration:none;color:#0084b4;">' . $product_name . '</a>'); ?>
																	<?php } else { ?>
																	<?php echo sprintf($text_general_question_answer, $author); ?>
																	<?php } ?>
																</p>
																<p style="margin:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#555555;font-size:14px;padding-top:10px;"><?php echo $text_admin_question; ?>
																	<br/>
														...
														<tr>
															<td>
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tbody>
																		<tr>
																			<td valign="top" style="width:60px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#666;font-size:24px;text-align:center;font-weight:bold;"> <?php echo $text_answer_short; ?> </td>
																			<td valign="top">
																				<div>
																				...
																				<div style="margin-top:10px;margin-left:15px;margin-bottom:0px;">
																					<span style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#333333;font-size:14px;font-weight:bold;line-height:1em;"><?php echo $answer_author; ?></span>
																					<span style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#999999;font-size:13px;font-style:italic;line-height:1em;margin-left:5px;">[ <?php if ($answer_author_email) { ?><a href="mailto:<?php echo $answer_author_email; ?>" style="text-decoration:none;color:#0084b4;"><?php echo $answer_author_email; ?></a>, <?php } ?><?php echo $answer_date; ?>, <?php echo $text_ip; ?> <a href="http://www.geoiptool.com/en/?IP=<?php echo $ip_address; ?>" style="text-decoration:none;color:#0084b4;"><?php echo $ip_address; ?></a> ]</span>
																				</div>
																			</td>
																		</tr>
																	</tbody>

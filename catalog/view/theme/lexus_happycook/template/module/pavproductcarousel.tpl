...
<div class="prod_list_top_banner">
  ...
  <div class="top_banner_nav">
    ...
    <div class="carousel-controls" style="margin:-13px 0 0 0; width:65px !important;"> <a class="banner_nav_left carousel-control left" style="margin:0 0 0 -30px !important; color:#af0917 !important;" href="#productcarousel<?php echo $id;?>"   data-slide="prev">&lsaquo;</a> <a class="banner_nav_right carousel-control right" style="right:-4px; color:#af0917 !important;" href="#productcarousel<?php echo $id;?>"  data-slide="next">&rsaquo;</a> </div>
    <?php } ?>
  </div>
  ...
  <?php } ?>
  <!--<div class="box-heading"><span><?php if($heading_title != 'Special'){ echo $heading_title; } ?></span></div>--->
  <div class="box-content" >
    <div class="box-products slide" id="productcarousel<?php echo $id;?>">
      <?php if( trim($message) ) { ?>
      <div class="box-description"><?php echo $message;?></div>

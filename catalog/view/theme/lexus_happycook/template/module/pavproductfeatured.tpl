...
<div class="box featured <?php echo $addition_class;?>">
	<h2 class="h2head" style="padding:25px 0 10px 0;"><span class="dot"><?php echo $heading_title; ?></span><span class="divider" style="width:95% !important;"></span></h2>
									...
									<?php foreach( $tproducts as $i => $product ) {  $i=$i+1;?>
										...
										<?php } ?>
											  <div class="pavcol-sm-<?php echo $cols;?> col-xs-12 col-sm-4">
												...
												<?php } ?>
													<div class="cart">
                                                    	<a href="javascript:void(0);" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="featured-btt"><?php if ($product['price']) { echo $product['price']; } ?></a>

...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="buttons">
      <div class="left">
      	<input type="<input type="submit" value="<?php echo $button_back; ?>" onclick="<?php echo $back; ?>" class="button" />" value="<?php echo $button_back; ?>" onclick="<?php echo $back; ?>" class="button" />
      </div>
      <div class="right">

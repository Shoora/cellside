...
<div class="row">
	<div class="col-sm-6">
    	<div class="prod_list_top_banner dark-gray" style="width:98% !important; float:left;">
                <div class="top_banner_title">NEW SKIN DESIGNS</div>
                <div class="top_banner_nav" style="margin-top:-75px !important;margin-right:-97px !important;">
                    <a href="#" class="banner_nav_left"></a>
                    <a href="#" class="banner_nav_right"></a>
                </div>
                <a href="#" class="top_banner_img" style="margin-top:0px !important;"><img src="/catalog/view/theme/cellside/img/demo/top_ban_img.png" width="150" height="135"></a>
                <div class="top_banner_info cf" style="margin-top:0px !important;">
                    <a href="#" class="top_banner_header">Red Metal Skin</a>
                    <span class="top_banner_text">Your phone gets a design makeover with<br /> our tough cases and ultra-thin skins. </span>
    ...
    <div class="col-sm-6">
    	<div class="prod_list_top_banner light-gray" style="width:98% !important; float:right;">
                ...
                <div class="top_banner_info cf" style="margin-top:0px !important;">
                    ...
                    <span class="top_banner_text" style="width:auto !important;">Your phone gets a design makeover with our<br /> tough cases and ultra-thin skins. </span>

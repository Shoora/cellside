...
<?php echo $content_top; ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-15">
        <header class="shopping_cart">shopping cart<?php if ($weight) { ?>
    &nbsp;(<?php echo $weight; ?>)
    <?php } ?></header>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
          ...
          <table class="table">
            <tr><th colspan="2">Item</th> <th>Price</th> <th>Quantity</th> <th>Total</th> <th>Remove</th></tr>
            ...
            <tr>
              ...
              <td class="desc">  <a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a><br />
  ...
  <?php } ?>        
        ...
        <div class="totals"> 
           ...
           <div class="wraper">
             ...
             <div class="row">
              <div class="col-sm-4 subtotal"><?php echo $total['title']; ?>:</div>
              <div class="col-sm-5 price"><?php echo $total['text']; ?></div>
            </div>
		  ...
		  <?php } ?>
            ...
            <div class="buttons"> 
                ...
                <a href="<?php echo $checkout; ?>"><div class=" medium medium_green">Checkout</div></a>

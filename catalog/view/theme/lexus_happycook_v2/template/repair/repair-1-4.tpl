...
<section class="main-container">
    <div class="container">
        <section class="contain-header">
            <div class="row">
                ...
                <div class="col-sm-6 service-header">
                    <h2 class="">Select the service for your device.</h2>
        ...
        <section class="list-devices">
            <ul class="clearfix select-device">
                <li>
                    <input type="radio" name="service" id="walk"/>
                    <label for="walk">
                        <span><i class="entypo box"></i> <br/>Walk-in Service</span>
                    </label>
                </li>
                <li>
                    <input type="radio" name="service" id="mail"/>
                    <label for="mail">
                        <span><i class="entypo paper-plane"></i> <br/>Mail-in Service</span>
                    </label>
                </li>
                <li>
                    <input type="radio" name="service" id="diy" checked="checked"/>
                    <label for="diy">
                        <span><i class="entypo tools"></i> <br/>DIY Repair</span>
                    </label>
                </li>
            </ul>
        </section>

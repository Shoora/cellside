    ...
    <div class="container">
        <section class="contain-header">
            <div class="row">
                ...
                <div class="col-xs-7">
                    <h2 class="service-name">Walk-in Repair</h2>
                </div>
            </div>
        </section>
        <section class="walk-in-repair">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="more-detail-spec">
                        <span class="fa fa-clock-o"></span> <span>Repair Duration:</span>
                        <span class="duration">45 Minutes</span>
                    </div>
                    <div class="price-order">
                        <div class="row">
                            <div class="col-lg-4 prd_price">$89<sup>.99<sup></div>
                            ...
                            <div class="col-lg-6 add-to-cart">
                                <a href="clearfix">
                ...
                <div class="col-sm-6">
                    <h3 class="service-name-detail">More repair info here</h3>
                    <p>Your phone gets a design makeover with our tough cases and ultra-thin skins. Protect and personalize your precious cargo with wrap-around design. Add a free matching wallpaper, too!</p>
                    <div class="map">
                        <img src="/catalog/view/theme/lexus_happycook_v2/images/new/map.png" alt=""/>
                    </div>
                </div>
            </div>
        </section>

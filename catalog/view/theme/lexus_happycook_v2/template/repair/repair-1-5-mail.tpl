    ...
    <div class="container">
        <section class="contain-header">
            <div class="row">
                ...
                <div class="col-xs-7">
                    <h2 class="service-name">Mail-in Repair</h2>
                </div>
            </div>
        </section>
        <section class="mail-in-repair">
            <div class="row" id="replacement">
                <div class="col-sm-5 order-info">
                    ...
                    <div class="mail-in-section">
                        <h4 class="service-name-section">Your Personal Details</h4>
                        <form role="form">
                    ...
                    <div class="mail-in-section">
                        <h4 class="service-name-section">Where should we return the phone</h4>
                        <form role="form">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="sr-only" for="Email">Please select City</label>
                                <div class="btn-cellside select-city">
                ...
                <div class="col-sm-6 col-sm-offset-1">
                    <div class="repair-more-info">
                        <div class="mail-in-section">
                            <h3 class="service-name-detail">Repair title goes here</h3>
                            <p>Your phone gets a design makeover with our tough cases and ultra-thin skins. Protect and personalize your precious cargo with wrap-around design. Add a free matching wallpaper, too!</p>
                        </div>
                        <div class="mail-in-section">
                        ...
                        <div class="price-order">
                            <div class="row">
                                <div class="col-lg-5 prd_price">$89<sup>.99<sup></div>

...
<section class="main-container">
    <div class="container">
        <section class="contain-header">
            <div class="row">
                <div class="col-sm-3 filter-feature">
                    <div class="btn-cellside btn-filter">
                        <div class="btn-cellside-label" id="dLabel" data-toggle="dropdown" data-hover="dropdown">
                            <span id="man-selected-label">Filter by Manufacturer</span>&nbsp;
                            <i class="fa fa-mobile-phone"></i>
                        </div>
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                            <li>
                                <a id="man-item-0" href="javascript:void(0);">
                                    All models
                                </a>
                            </li>
                            <?php foreach( $manufacturers as $item ) { ?>
                            <li <?php if($selected == $item['category_id']) { ?>id="man-selected"<?php } ?>>
                                <a id="man-item-<?= $item['category_id'] ?>" href="javascript:void(0);">
                                    <?= $item['name'] ?>
                                </a>
                            </li>
                            <?php } ?>
                ...
                <div class="col-sm-6 service-header">
                    <h2 class="">Select and find your device.</h2>
        ...
        <section class="list-products">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="product-item product-trigger" id="product-item-<?=$category['category_id']?>">
                        <div class="product-item-thumb">
                            <a href="javascript:void(0);"><img src="/image/<?=$category['image']?>" alt=""/></a>
                        </div>
                        <div class="product-item-name">
                            <h5><a href="javascript:void(0);"><?=$category['name']?></a></h5>
                        </div>
                        <div class="product-item-decor"></div>
                    </div>
                </div>
                <?php } ?>
            </div>
    ...
    <div class="container">
        ...
        <div class="recommend-product-list">
                ...
                <ul class="clearfix">
                    <li class="recommend-item">
                        <div class="col-product-item">
                            ...
                            <div class="product-item-name"><h5>
                                    <a href="">Premium Line 10ft Micro-USB Charge & Data Sync Cable (Blue) for HTC
                                        One</a>
                                </h5></div>
                    ...
                    <li class="recommend-item">
                        <div class="col-product-item">
                            ...
                            <div class="product-item-name"><h5>
                                    <a href="">HTC OEM Double Dip Case (Grey Red) (99H11110600) for HTC One</a></h5>
                            </div>
                            <div class="product-item-ratings"><img src="/catalog/view/theme/lexus_happycook_v2/images/new/stars-3.png" alt=""/></div>
                            <div class="product-item-add-cart">
                                <a href="" class="btn-add-cart">
                    ...
                    <li class="recommend-item">
                        <div class="col-product-item">
                            ...
                            <div class="product-item-name"><h5>
                                    <a href="">OtterBox Realtree Xtra Camo Defender Series Case (Xtra Green:
                                        Black/Green) HTC One</a>
                                </h5></div>
                            <div class="product-item-ratings"><img src="/catalog/view/theme/lexus_happycook_v2/images/new/stars-3.png" alt=""/></div>
                            <div class="product-item-add-cart">
                                <a href="" class="btn-add-cart">
            ...
            <div class="carousel_control">
                <a href="#" class="jcarousel-control-prev inactive" data-jcarouselcontrol="true"><i

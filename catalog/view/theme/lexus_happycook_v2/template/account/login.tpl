					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						...
						<div class="row login_choice">
							...
							<div class="col-sm-6 login_social">
								<a href="#"> <img src="catalog/view/theme/lexus_happycook_v2/img/facebook.png"> </a>
								<p>or</p>
								<a href="#"> <img src="catalog/view/theme/lexus_happycook_v2/img/twitter.png"> </a>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-md-offset-1 col-lg-offset-1 register">
						<div class="row">
							<div class="col-sm-10">

...
<div id="group-content"><?php echo $content_top; ?>
<?php if( $SPAN[0] ): ?>
...
<div id="content"><?php echo $content_top; ?>
	...
	<h1 class="checkout-title"><?php echo $heading_title; ?></h1>
	<section class="service-steps">
		<div class="container">
			<ul class="five-steps clearfix">
					...
					<div class="step-item label-device">
						<div class="step-item-inner">
							<div class="step-item-container">
								<div class="step-item-label">1. Checkout Options</div> <i class="fa fa-th-list"></i>
				...
				<li data-type="#payment-address">
					<div class="step-item label-color">
						<div class="step-item-inner">
							<div class="step-item-container">
								<div class="step-item-label">2. Billing Details</div> <i class="fa fa-list-alt"></i>
								<div class="step-item-decor">
									<div class="step-item-decor-inner"></div>
								</div>
							</div>
				...
				<li data-type="#shipping-address">
					<div class="step-item label-issue">
						<div class="step-item-inner">
							<div class="step-item-container">
								<div class="step-item-label">3. Delivery Details</div> <i class="fa fa-globe"></i>
								<div class="step-item-decor">
									<div class="step-item-decor-inner"></div>
								</div>
							</div>
				...
				<li data-type="#shipping-method">
					<div class="step-item label-service">
						<div class="step-item-inner">
							<div class="step-item-container">
								<div class="step-item-label">4. Delivery Method</div> <i class="fa fa-plane"></i>
								<div class="step-item-decor">
									<div class="step-item-decor-inner"></div>
								</div>
							</div>
				...
				<li data-type="#payment-method">
					<div class="step-item label-price">
						<div class="step-item-inner">
							<div class="step-item-container">
								<div class="step-item-label">5. Payment Method</div> <i class="fa fa-credit-card"></i>
								<div class="step-item-decor">
									<div class="step-item-decor-inner"></div>
								</div>
							</div>
				...
				<li data-type="#confirm">
					<div class="step-item label-price">
						<div class="step-item-inner">
							<div class="step-item-container">
								<div class="step-item-label">6. Confirm Order</div> <i class="fa fa-check"></i>
								<div class="step-item-decor">
									<div class="step-item-decor-inner"></div>
								</div>
							</div>
...
function changeStep(step) { //passed-step current-step
	$('.service-steps').find('li').each(function() {
		if (!$(this).hasClass('current-step') && !$(this).hasClass('passed-step')) {
...
function moveButtons(selector) {
	var button = $(selector).find('.buttons').clone( true );
	$('.buttons').remove();
	$(selector).find('.checkout-content').after(button);
}

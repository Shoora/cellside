...
<!--<div class="box-heading" style="margin:0px !important; border:none !important; padding:0px !important;">
	<span class="filter_text" style="padding:0px !important; margin:0px !important;"><?php echo "Price Filter"; ?></span>
...
<div class="price_slider">
	<div style="display: none;">
		...
		<input type="text" id="min_price" value="-1" name="min_price" readonly="readonly" class="price_limit price_tooltip">
		<label> - </label>
		<input type="text" id="max_price" value="-1" name="max_price" readonly="readonly" class="price_limit price_tooltip">	
	</div>
	<span class="sidebar_filter_text"><?php echo $text_price_range?></span>
	<div class="clearfix"></div>
	<div id="min_tooltip" class="price_tooltip"><span>$0</span><div class="price_arrow_one"></div></div>
	<div id="max_tooltip" class="price_tooltip"><span>$500</span><div class="price_arrow_one"></div></div>
	<?php if($symbol_right){ echo "<label>" . $symbol_right . "</label>";}?>
	<div id="slider-range"></div>
	<!-- <div class="filter_button_container cf">
		<input type="submit" id="price_submit" class="sidebar_filter_button filter_button_one button" value="Ok">
